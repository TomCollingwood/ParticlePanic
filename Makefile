...
# Template: app
# Command: /home/tom/Qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ParticlePanic.pro
#############################################################################
...
LIBS          = $(SUBLIBS) -L/usr/local/lib -lSDL2 -lGLU -lSDL2_image -L/usr/local/lib/ -lGL -L/home/tom/Qt/5.5/gcc_64/lib -lQt5Gui -L/usr/lib64 -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: ParticlePanic.pro ../../../Qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ParticlePanic.pro
